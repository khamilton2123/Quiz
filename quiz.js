...
highscoresbtn.addEventListener("click",highscoresBTN);

function highscoresBTN(event) {
 ...
 function showResponse(event) {
            ...
            submissionResponseEl = response + "-" + scoreNumber;
                if(submissionResponseEl !==null){
                    highscores.push(submissionResponseEl);
                }
